                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        <label for="payment_date">{{ __($modalTitle) }} {{ __('Date') }}</label>
                                        <input id="payment_date" name="payment_date" type="text"
                                            placeholder="{{ __('Select') }} {{ __('Date') }}"
                                            class="form-control @error('payment_date') is-invalid @enderror"
                                            value="{{ old('payment_date') }}" autocomplete="off" readonly>
                                    ...
                                    <table class="table" id="payment-table">
                                            ...
                                            <tr class="payment-row">
                                                ...
                                                <td>
                                                    <input type="text" name="payments[0][note]" class="form-control"
                                                        value="{{ old('payments.0.note') }}">
                                                </td>
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-danger remove-payment-row"><i
                                                            class="la la-trash"></i></button>
                                                    <input type="hidden" name="payments[0][is_remove]" value="0"
                                                        class="remove-entry-payment">
                                                </td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tfoot>
                                            <tr class="text-right">
                                                ...
                                                <th id="total-payment-amount">0.00</th>
                                                <th></th>
                                            </tr>
                                        </tfoot>
                                    </table>
...
<!-- Confirmation Modal -->
<div class="modal fade" id="confirmationModalPayment" tabindex="-10" role="dialog"
    aria-labelledby="confirmationModalPaymentLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmationModalPaymentLabel">{{ __('Confirm Removal') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="confirmRemovePayment">{{ __('Remove') }}</button>
            </div>
        </div>
    </div>
</div>
