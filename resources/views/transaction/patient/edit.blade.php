...
@section('title')
    {{ __('Edit') }} {{ __('Patient') }} | {{ config('app.name') }}
@endsection
...
@section('breadcrumb')
    ...
    <span class="kt-subheader__breadcrumbs-separator"></span><a href="{{ route('patient.edit', $patient->id) }}"
        class="kt-subheader__breadcrumbs-link">{{ __('Edit') }} {{ __('Patient') }}</a>
@endsection

@section('content')
    <form class="kt-form" id="kt_form_1" action="{{ route('patient.update', $patient->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="kt-portlet" id="kt_page_portlet">
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">{{ __('Edit') }} {{ __('Patient') }}</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="name" name="name" type="text"
                                    ...
                                    value="{{ old('name', $patient->name) }}" autocomplete="off">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="nik" name="nik" type="number"
                                        ...
                                        value="{{ old('nik', $patient->nik) }}" autocomplete="off">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="dob" name="dob" type="date"
                                        ...
                                        value="{{ old('dob', $patient->dob) }}" autocomplete="off">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="phone" name="phone" type="text"
                                        ...
                                        value="{{ old('phone', $patient->phone) }}" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="insurance_name" name="insurance_name" type="text"
                                    ...
                                    value="{{ old('insurance_name', $patient->insurance_name) }}" autocomplete="off">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="insurance_no" name="insurance_no" type="number"
                                    ...
                                    value="{{ old('insurance_no', $patient->insurance_no) }}" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea id="address" name="address" rows="3" class="form-control @error('address') is-invalid @enderror"
                                    autocomplete="off">{{ old('address', $patient->address) }}</textarea>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea id="note" name="note" rows="3" class="form-control @error('note') is-invalid @enderror"
                                    autocomplete="off">{{ old('note', $patient->note) }}</textarea>
