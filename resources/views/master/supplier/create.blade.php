...
@section('breadcrumb')
    ...
    <span class="kt-subheader__breadcrumbs-separator"></span><a href="{{ route('master.supplier.create') }}"
        class="kt-subheader__breadcrumbs-link">{{ __('Create') }} {{ __('Supplier') }}</a>
@endsection

@section('content')
    <form class="kt-form" id="kt_form_1" action="{{ route('master.supplier.store') }}" method="POST">
        @csrf
