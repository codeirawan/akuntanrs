...
@section('breadcrumb')
    <span class="kt-subheader__breadcrumbs-separator"></span><a href="{{ route('master.supplier.index') }}"
        class="kt-subheader__breadcrumbs-link">{{ __('Suppliers') }}</a>
@endsection
        ...
        <div class="kt-portlet__body">
            <div class="kt-portlet__content">
                ...
                @if (Laratrust::isAbleTo('create-master'))
                    <a href="{{ route('master.supplier.create') }}" class="btn btn-primary mb-4">
...
@section('script')
    ...
    <script type="text/javascript">
        $('#kt_table_1').DataTable({
            ...
            ajax: {
                method: 'POST',
                url: '{{ route('master.supplier.data') }}',
                headers: {
