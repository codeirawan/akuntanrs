...
@section('title')
    {{ __('Fiscal Year') }} | {{ config('app.name') }}
@endsection
        ...
        <div class="kt-portlet__body">
            <div class="kt-portlet__content">
                ...
                @if (Laratrust::isAbleTo('create-master'))
                    <a href="{{ route('master.fiscal-year.create') }}" class="btn btn-primary mb-4">
                        <i class="fa fa-plus"></i> {{ __('New Fiscal Year') }}
                    </a>
                @endif
...
@section('script')
    @include('layouts.inc.modal.delete', ['object' => 'fiscal-year'])
    ...
    <script type="text/javascript">
        $('#kt_table_1').DataTable({
            ...
            ajax: {
                method: 'POST',
                url: '{{ route('master.fiscal-year.data') }}',
                headers: {
